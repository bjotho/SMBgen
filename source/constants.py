...
DONE = 'done'
UPDATE_RADIUS = 1.5 * SCREEN_WIDTH
...
N_FEATURES = len(GENERATOR_TILES)
LEARNING_RATE = 0.001
MEMORY_LENGTH = 128

# GENERATION DQN PARAMETERES
REPLAY_MEMORY_SIZE = 10_000
MIN_REPLAY_MEMORY_SIZE = 5
MINIBATCH_SIZE = 5
MINIBATCH_SIZE = MIN_REPLAY_MEMORY_SIZE if MINIBATCH_SIZE > MIN_REPLAY_MEMORY_SIZE else MINIBATCH_SIZE  # TODO - ensrue that memsize !=
DISCOUNT = 0.99
